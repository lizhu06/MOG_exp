...
for s = 1:num_simu
	%----------------------- load Data -----------------------
	true_beta = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/true_beta_", num2str(s), ".csv"));                                     
	X_train = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/X_train_", num2str(s), ".csv"));
	Y_train = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/Y_train_", num2str(s), ".csv"));
	X_test = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/X_test_", num2str(s), ".csv"));
	Y_test = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/Y_test_", num2str(s), ".csv"));

	%----------------------- analysis -----------------------
	inner_fold_id = csvread(strcat("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Data/U2/innerFoldID_", num2str(s), ".csv"));
...
csvwrite("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Results/U2_SLEP_BEST_Z.csv",BEST_Z);
csvwrite("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Results/U2_SLEP_MSE.csv",MSE);
csvwrite("/ihome/ctseng/liz86/MOG/Exp_revision1/Simu3_nonOverlapping/Results/U2_SLEP_AUC.csv",AUC);
