...
for(i in 1:5){
    ...
    write.csv(pathwayTable, 
        file=paste("/mnt/glusterfs/liz86/MOG_Regression/Exp/app1_morePathways/Results/ER_KEGG_SGL_pathway_table_CV", i, "_balanced.csv", 
            sep=""), row.names=FALSE)
...
mean(AUC_SGL)  #0.683
sd(AUC_SGL)/sqrt(5) #0.113

save(nonzero_SGL, file="nonzero_SGL_balanced.RData")
save(nonzero_ER_SGL, file="nonzero_ER_SGL_balanced.RData")
...
save.image("SGL_ER_5CV_balanced.RData")
